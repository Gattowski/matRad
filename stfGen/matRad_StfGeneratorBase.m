classdef matRad_StfGeneratorBase
    ...
    methods (Access = protected)
        ...
        function initializePatientGeometry(this,ct,cst)
            ...
            V = ct.cubeDim;
            ctConverted = matRad_calcWaterEqD(ct);
    ...
    % with OCTAVE we can't use abstract methods. If OCTAVE at some point in
    % the far future implements this feature this should be abstract again.
